          ...
          <UserProvider>
            <DefaultLayout>
              <Routes>
                ...
                <Route path='lecturer'>
                  <Route path='dashboard/courses' element={<LecturerDashboardCourses />} />
                  <Route path='dashboard/problems' element={<LecturerDashboardProblems />} />
                ...
                <Route path='admin'>
                  <Route index element={<Navigate to='/admin/users' replace={true} />} />
                  <Route path='users' element={<AdminDashboardUser />} />
                  <Route path='problems' element={<AdminDashboardProblem />} />
                  <Route path='submissions' element={<AdminDashboardSubmission />} />
