...
export default function Problems() {
  ...
  const handleClearFolder = async () => {
    const res = await axiosAPI.get(endpoints.problems + "/get-folders-invalid");
              ...
              data.map((row) => (
                ...
                >
                  ...
                  <TableCell align="center">
                    {(row.timeStart && handleDatetime(row.timeStart, true)) ||
                      "---"}
                  </TableCell>
                  <TableCell align="center">{row.testTime || "---"}</TableCell>
                  <TableCell align="center">
                    {(row.timeEnd && handleDatetime(row.timeEnd, true)) ||
                      "---"}
                  </TableCell>
                  <TableCell align="center">
                    {row.initCode &&
