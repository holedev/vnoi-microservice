...
function Edit({ setListUser, edit, setEdit, user, setUser, classList, ...props }) {
  ...
  return (
    <Modal {...props} open={edit} onClose={handleClose}>
      ...
      >
        <DialogTitle id='responsive-dialog-title'>Update USER</DialogTitle>
        <DialogContent>
          <Stack direction='row' spacing={3} sx={{ display: { md: "flex" }, my: 1 }}>
            <Stack
              direction='column'
              sx={{
                position: "relative"
            ...
            >
              ...
              >
                <img src={data?.avatar} loading='lazy' alt='avt' />
              </AspectRatio>
            </Stack>
              ...
              >
                <FormControl sx={{ flexGrow: 1 }}>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleEditUser(e.target.value, "studentCode")}
                  />
                </FormControl>
                ...
                <FormControl sx={{ flexGrow: 1 }}>
                  ...
                  <Autocomplete
                    ...
                    placeholder='Class'
                    options={classList}
                    onChange={(event, newValue) => handleEditUser(newValue, "classCurr")}
                    getOptionLabel={(option) => option?.name || ""}
                    isOptionEqualToValue={(option, value) =>
                      value === undefined || value === "" || value == {} || option.name === value.name
                    }
                  />
                </FormControl>
              </Stack>
              <Stack spacing={1}>
                ...
                >
                  <Input
                    ...
                    value={data.fullName}
                    onChange={(e) => handleEditUser(e.target.value, "fullName")}
                  />
                </FormControl>
              </Stack>
              <Stack direction='row' spacing={2}>
                <FormControl>
                  ...
                  <Select
                    ...
                    size='small'
                    value={data.role || ""}
                    onChange={(event, value) => handleEditUser(value, "role")}
                  >
