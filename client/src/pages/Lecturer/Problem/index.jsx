            ...
            if (["txt"].includes(fileExtension)) {
                ...
                reader.onload = (e) => {
                    ...
                    if (data.length === tcLength) {
                        toast.error(
                            "You must have a empty line at the end of file!"
                        );
                        return;
                    }
                ...
                toast.error(
                    "Unsupported file type. Please select a .txt file."
                );
            }
            e.target.value = null;
        }
                    ...
                    <Box className={styles.headingBody}>
                        <Box className={styles.headingLeft}>
                            <TextField
                                ...
                                value={data.title}
                                onChange={(e) =>
                                    handleData(e.target.value, "title")
                                }
                        ...
                        <Box className={styles.headingRight}>
                            ...
                            >
                                ...
                                <TextField
                                    ...
                                    value={data.testTime}
                                    onChange={(e) =>
                                        handleData(e.target.value, "testTime")
                                    }
                ...
                <Box data-tour="problem-testcase" className={styles.group}>
                    ...
                    >
                        ...
                        {!useFileTC && (
                            <TextField
                                ...
                                onChange={(e) =>
                                    handleScriptG(e.target.value, "quantity")
                                }
                                size="small"
                                id="outlined-basic"
                                label="Quantity"
                    ...
                    {!useFileTC && (
                        <Editor
                            ...
                            setState={(value) => {
                                if (!useFileTC)
                                    handleScriptG(value, "generateCode");
                            }}
                        />
                    )}
                </Box>
