export const steps = [
  ...
  },
  {
    ...
    content: (
      <p>
        This is the {"problem's"} SOLUTION section! Ensure your code is enclosed within three backticks (```) to
        designate the start and end of the code block. Currently, we only support C++ solutions. More languages will be
        added in our next update! You can see an example solution{" "}
        <a rel='noreferrer' href='https://github.com/anvyidol/vnoi-hcmc/tree/master/example' target='_blank'>
          here
        </a>
        .
      </p>
  ...
  },
  {
    ...
    content: "You can also upload your solution from a file. We support .cpp, .c, and .txt files."
  },
  {
    target: `[data-tour="problem-testcase"]`,
    content: (
      <p>
        This is the {"problem's"} TESTCASE! You must write a script Javascript to generate testcases for your problem.
        The script must be a function that returns a string contain value concat with `\\n`. The script must be enclosed
        within three backticks (```). You can see an example script{" "}
        <a rel='noreferrer' href='https://github.com/anvyidol/vnoi-hcmc/tree/master/example' target='_blank'>
          here
        </a>
        .
  ...
  },
  {
    ...
    content: "You can test your script by clicking this button. The result demo will be displayed."
  },
  {
    target: `[data-tour="testcase-with-file"]`,
    content: (
      <p>
        You can also upload your input testcase from a file. We support .txt files. In the first line, please specify
        the number of test cases and the number of lines in each test case. You can see an example file{" "}
        <a rel='noreferrer' href='https://github.com/anvyidol/vnoi-hcmc/tree/master/example' target='_blank'>
          here
        </a>
        .
