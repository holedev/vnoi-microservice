  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <SearchDebounce search={search} setSearch={setSearch} fn={getProblems} />
          ...
          <FormControl sx={{ m: 1, minWidth: 120 }} size='small'>
            <Select value={filter.status || "all"} onChange={(e) => handleFilter(e.target.value, "status")}>
          ...
          <FormControl sx={{ m: 1, minWidth: 120 }} size='small'>
            <Select value={filter.time || "all"} onChange={(e) => handleFilter(e.target.value, "time")}>
              <MenuItem value='all'>ALL</MenuItem>
            ...
            {loading ? (
              ...
              problems.map((row) => (
                ...
                >
                  ...
                  <TableCell align='center'>{row.status ? row.solution : "---"}</TableCell>
                </TableRow>
              ))
            ) : (
              <TableRow>
